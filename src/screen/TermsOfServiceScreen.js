...
const TermsOfServiceScreen = () => {
  ...
  return (
    <div>
      ...
      <p>Welcome to webstore!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of STERN inc.'s Website, located at WebStern.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use webstore if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of il. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing webstore, you agreed to use
        cookies in agreement with the STERN inc.'s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, STERN inc. and/or its licensors own the
        intellectual property rights for all material on webstore. All
        intellectual property rights are reserved. You may access this from
        webstore for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from webstore</li>
        <li>Sell, rent or sub-license material from webstore</li>
        <li>Reproduce, duplicate or copy material from webstore</li>
        <li>Redistribute content from webstore</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. STERN
        ...
        of STERN inc.,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, STERN inc. shall not be liable for
      ...
      <p>
        STERN inc. reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant STERN inc. a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of STERN inc.; and (d) the link is
      ...
      <p>
        ...
        e-mail to STERN inc.. Please include your name, your organization name,
      ...
      <p>
        No use of STERN inc.'s logo or other artwork will be allowed for linking
